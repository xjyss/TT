...
class Spider(BaseSpider):
    ...
    def get_working_host(self):
        dynamic_urls = [
            'https://because.uaklkrqm.cc',
            'https://anybody.uaklkrqm.cc',
            'https://afraid.uaklkrqm.cc',
            'https://dqdzh4jlvme4h.cloudfront.net'
            #发布页'https://91cg5.com'
        ]
    ...
    def homeContent(self, filter):
            ...
            classes = [
                 {'type_name': '今日吃瓜','type_id': '/category/zxcghl/'},
                 {'type_name': '必吃大瓜','type_id': '/category/bcdg/'},
                 {'type_name': '网红黑料','type_id': '/category/whhl/'},
                 {'type_name': '明星黑料','type_id': '/category/mxhl/'},
                 {'type_name': '社会奇闻','type_id': '/category/qwys/'},
                 {'type_name': '每日大赛','type_id': '/category/mrds/'},
                 {'type_name': 'AI短剧','type_id': '/category/dydj/'},
                 {'type_name': '深夜撸片','type_id': '/category/lpsd/'},
                 {'type_name': '海角乱伦','type_id': '/category/hjll/'},
                 {'type_name': '91探花','type_id': '/category/91th/'},
                 {'type_name': '成人动漫','type_id': '/category/crdm/'},
                 {'type_name': '师生专栏','type_id': '/category/xsjlb/'},
                 {'type_name': '反差靓女','type_id': '/category/fclv/'},
                 {'type_name': '投稿求瓜','type_id': '/category/tgqg/'},
                 {'type_name': '网黄合集','type_id': '/category/gcwh/'},
                 {'type_name': '明星AI','type_id': '/category/aikj/'},
                 {'type_name': '自拍偷拍','type_id': '/category/zptp/'},
                 {'type_name': '猎奇重口','type_id': '/category/lqzk/'}
          ]
    ...
    def detailContent(self, ids):
        try:
            ...
            if not vod_content:
                vod_content = data('h2').text() or '91吃瓜中心'
