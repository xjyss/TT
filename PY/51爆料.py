...
class Spider(BaseSpider):
    ...
    def get_working_host(self):
        dynamic_urls = [
            'https://bike.uudyxpcyc.cc',
            'https://blow.uudyxpcyc.cc',
            'https://before.uudyxpcyc.cc',
            'https://d2hriolbecggrv.cloudfront.net'
           #51爆料发布页 'https://www.dtvlyzaqv.com'
        ]
    ...
    def homeContent(self, filter):
            ...
            classes = [
                 {'type_name': '今日爆料','type_id': '/category/jrbl/'},
    ...
    def detailContent(self, ids):
        try:
            ...
            if not vod_content:
                vod_content = data('h2').text() or '51爆料'
