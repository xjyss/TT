...
class Spider(Spider):
    ...
    def _extractVideoItems(self, html_content):
        ...
        try:
            # 兼容多种列表模板
            items = re.findall(r'<a[^>]*class="vodbox"[^>]*href="([^"]+)"[^>]*>.*?<img[^>]*data-original="([^"]+)"[^>]*>.*?<p[^>]*class="km-script[^"]*"[^>]*>(.*?)</p>', html_content, re.S)
            if not items:
    ...
    def homeContent(self, filter):
        result = {}
        classes = [
             {'type_id': '/index.php/vod/type/id/1.html', 'type_name': '全部视频'},
             {'type_id': '/index.php/vod/type/id/13.html', 'type_name': '香蕉精品'},
             {'type_id': '/index.php/vod/type/id/22.html', 'type_name': '制服诱惑'},
             {'type_id': '/index.php/vod/type/id/6.html', 'type_name': '国产视频'},
             {'type_id': '/index.php/vod/type/id/8.html', 'type_name': '清纯少女'},
             {'type_id': '/index.php/vod/type/id/9.html', 'type_name': '辣妹大奶'},
             {'type_id': '/index.php/vod/type/id/10.html', 'type_name': '女同专属'},
             {'type_id': '/index.php/vod/type/id/11.html', 'type_name': '素人出演'},
             {'type_id': '/index.php/vod/type/id/12.html', 'type_name': '角色扮演'},
             {'type_id': '/index.php/vod/type/id/20.html', 'type_name': '人妻熟女'},
             {'type_id': '/index.php/vod/type/id/23.html', 'type_name': '日韩剧情'},
             {'type_id': '/index.php/vod/type/id/21.html', 'type_name': '经典伦理'},
             {'type_id': '/index.php/vod/type/id/7.html', 'type_name': '成人动漫'},
             {'type_id': '/index.php/vod/type/id/14.html', 'type_name': '精品二区'},
