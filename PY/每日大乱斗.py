...
class Spider(BaseSpider):
    ...
    def get_working_host(self):
        dynamic_urls = [
            'https://bend.nwzeuskva.cc',
            'https://better.nwzeuskva.cc',
            'https://birth.nwzeuskva.cc',
            'https://d21bv9octs0ew4.cloudfront.net'
           #每日大乱斗发布页 'https://idld66.com'
        ]
    ...
    def homeContent(self, filter):
            ...
            classes = [
                 {'type_name': '今日乱斗','type_id': '/category/mrld/'},
                 {'type_name': '热搜排行榜','type_id': '/category/rsphb/'},
                 {'type_name': '必看大瓜','type_id': '/category/bkdg/'},
                 {'type_name': '每日大赛','type_id': '/category/mrds/'},
                 {'type_name': '海角乱伦','type_id': '/category/yjll/'},
                 {'type_name': '网红黑料','type_id': '/category/whhl/'},
                 {'type_name': '校园萝莉','type_id': '/category/xsxy/'},
                 {'type_name': '欧美精选','type_id': '/category/omjx/'},
                 {'type_name': '日韩精选','type_id': '/category/rhjx/'},
                 {'type_name': '御姐熟女','type_id': '/category/fssn/'},
                 {'type_name': '成人动漫','type_id': '/category/ldds/'},
                 {'type_name': '极限偷拍','type_id': '/category/jxtp/'},
                 {'type_name': '世界杯专题','type_id': '/category/worldcup/'},
                 {'type_name': 'AI短剧','type_id': '/category/aidj/'},
                 {'type_name': '吃瓜猎奇','type_id': '/category/cglq/'},
                 {'type_name': '看片精选','type_id': '/category/kpjx/'}
          ]
    ...
    def detailContent(self, ids):
        try:
            ...
            if not vod_content:
                vod_content = data('h2').text() or '每日大乱斗'
