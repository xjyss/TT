...
class Spider(BaseSpider):
    ...
    def get_working_host(self):
        dynamic_urls = [
            'https://because.hianndqo.cc',
            'https://after.hianndqo.cc',
            'https://brain.hianndqo.cc'
           #51吃瓜发布页 'https://www.rudhhtpz.com'
        ]
    ...
    def homeContent(self, filter):
            ...
            classes = [
                 {'type_name': '学生校园','type_id': '/category/xsxy/'},
                 {'type_name': '网红黑料','type_id': '/category/whhl/'},
                 {'type_name': '热门大瓜','type_id': '/category/rdsj/'},
                 {'type_name': '吃瓜榜单','type_id': '/category/mrdg/'},
                 {'type_name': '必看大瓜','type_id': '/category/bkdg/'},
                 {'type_name': 'AI成人短剧','type_id': '/category/cbdj/'},
                 {'type_name': '看片娱乐','type_id': '/category/ysyl/'},
                 {'type_name': '每日大赛','type_id': '/category/mrds/'},
                 {'type_name': '伦理道德','type_id': '/category/lldd/'},
                 {'type_name': '国产剧情','type_id': '/category/gcjq/'},
                 {'type_name': '探花精选','type_id': '/category/thjx/'},
                 {'type_name': '网黄合集','type_id': '/category/whhj/'},
                 {'type_name': '骚男骚女','type_id': '/category/snsn/'},
                 {'type_name': '明星黑料','type_id': '/category/whmx/'},
                 {'type_name': '海外吃瓜','type_id': '/category/hwcg/'},
                 {'type_name': '人人吃瓜','type_id': '/category/rrcg/'},
                 {'type_name': '领导干部','type_id': '/category/ldcg/'},
                 {'type_name': '软萌甜妹','type_id': '/category/jpll/'},
                 {'type_name': '世界杯专栏','type_id': '/category/sjb/'},
                 {'type_name': '吃瓜看戏','type_id': '/category/qubk/'},
                 {'type_name': '擦边聊骚','type_id': '/category/dcbq/'},
                 {'type_name': '51涨知识','type_id': '/category/zzs/'},
                 {'type_name': '吃瓜新闻','type_id': '/category/cgxw/'},
                 {'type_name': '原创博主','type_id': '/category/yczq/'},
                 {'type_name': '51剧场','type_id': '/category/51djc/'}
          ]
    ...
    def detailContent(self, ids):
        try:
            ...
            if not vod_content:
                vod_content = data('h2').text() or '51吃瓜'

            return {'list': [{'vod_play_from': '51吃瓜', 'vod_play_url': play_url, 'vod_content': vod_content}]}
        except:
            return {'list': [{'vod_play_from': '51吃瓜', 'vod_play_url': '获取失败'}]}
