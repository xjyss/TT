...
class Spider(BaseSpider):
    ...
    def get_working_host(self):
        dynamic_urls = [
            'https://ahead.njwpwtwmf.cc',
            'https://against.njwpwtwmf.cc',
            'https://affair.njwpwtwmf.cc',
            'https://d3bcf7zj9brv90.cloudfront.net'
           #51大赛发布页 'https://51hjds33.com'
        ]
    ...
    def homeContent(self, filter):
            ...
            classes = [
                 {'type_name': '每日吃瓜','type_id': '/category/JRCG/'},
                 {'type_name': '热搜吃瓜','type_id': '/category/RSCG/'},
                 {'type_name': 'AI专区','type_id': '/category/SJBCG/'},
                 {'type_name': '乱伦社区','type_id': '/category/LLSQ/'},
                 {'type_name': '精选合集','type_id': '/category/JXHJ/'},
                 {'type_name': '网红网黄','type_id': '/category/WHWH/'},
                 {'type_name': '必撸精品','type_id': '/category/XMLP/'},
                 {'type_name': '校园约炮','type_id': '/category/XYYP/'},
                 {'type_name': 'AV女优','type_id': '/category/AVNY/'},
                 {'type_name': '探花绿帽','type_id': '/category/THLM/'},
                 {'type_name': '萝莉自慰','type_id': '/category/LLZW/'},
                 {'type_name': '欧美重口','type_id': '/category/OMZK/'},
                 {'type_name': '黑料奇闻','type_id': '/category/HLQW/'},
                 {'type_name': '御姐骚女','type_id': '/category/YJSN/'},
                 {'type_name': 'AI专区','type_id': '/category/SJBCG/'}
          ]
    ...
    def detailContent(self, ids):
        try:
            ...
            if not vod_content:
                vod_content = data('h2').text() or '51大赛'
