...
class Spider(Spider):
    ...
    def homeContent(self, filter):
        result = {}
        classes = [
            {'type_id': '/index.php/vod/type/id/2.html', 'type_name': '全部'},
            {'type_id': '/index.php/vod/type/id/12.html', 'type_name': '韩国'},
            {'type_id': '/index.php/vod/type/id/11.html', 'type_name': '欧美'},
            {'type_id': '/index.php/vod/type/id/16.html', 'type_name': '无码'},
            {'type_id': '/index.php/vod/type/id/23.html', 'type_name': '直播'},
            {'type_id': '/index.php/vod/type/id/14.html', 'type_name': '字幕'},
            {'type_id': '/index.php/vod/type/id/58.html', 'type_name': '传媒'},
            {'type_id': '/index.php/vod/type/id/34.html', 'type_name': '探花'},
            {'type_id': '/index.php/vod/type/id/32.html', 'type_name': '网黄'},
            {'type_id': '/index.php/vod/type/id/61.html', 'type_name': 'JK'},
            {'type_id': '/index.php/vod/type/id/15.html', 'type_name': '国产'},
            {'type_id': '/index.php/vod/type/id/13.html', 'type_name': '热门'}
        ]
