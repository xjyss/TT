...
class Spider(BaseSpider):
    ...
    def get_working_host(self):
        dynamic_urls = [
            'https://adult.aaammmrg.cc',
            'https://admit.aaammmrg.cc',
            'https://d9altmxkp5q0i.cloudfront.net'
            #发布页'https://www.sjwdarqm.cc'
        ]
    ...
    def homeContent(self, filter):
            ...
            classes = [
                 {'type_name': '今日大瓜','type_id': '/category/jrgb/'},
                 {'type_name': 'AI短剧','type_id': '/category/aidj/'},
                 {'type_name': '优先投放区','type_id': '/category/shijiebei/'},
                 {'type_name': '每日大赛','type_id': '/category/mrds/'},
                 {'type_name': '海角社区','type_id': '/category/hjsq/'},
                 {'type_name': '午夜剧场','type_id': '/category/crfys/'},
                 {'type_name': '动漫天堂','type_id': '/category/dmhv/'},
                 {'type_name': '水果派解说','type_id': '/category/sgpjs/'},
                 {'type_name': '独家爆料','type_id': '/category/rmgb/'},
                 {'type_name': '黑料排行','type_id': '/category/rlph/'},
                 {'type_name': '热点吃瓜','type_id': '/category/ssdbl/'},
                 {'type_name': '校园吃瓜','type_id': '/category/xyss/'},
                 {'type_name': '反差爆料','type_id': '/category/bgzq/'},
                 {'type_name': '网红黑料','type_id': '/category/whbl/'},
                 {'type_name': '明星吃瓜','type_id': '/category/mxhl/'},
                 {'type_name': '猎奇吃瓜','type_id': '/category/blqw/'},
                 {'type_name': '偷窥泄密','type_id': '/category/tksm/'},
                 {'type_name': 'SM专区','type_id': '/category/zksr/'},
                 {'type_name': '男男女女','type_id': '/category/ntll/'},
                 {'type_name': '探花经典','type_id': '/category/thjx/'},
                 {'type_name': '福利视频','type_id': '/category/fljq/'},
                 {'type_name': '网黄专辑','type_id': '/category/crlz/'},
                 {'type_name': '影视床戏','type_id': '/category/slec/'},
                 {'type_name': '看片专辑','type_id': '/category/kpzj/'}
          ]
    ...
    def categoryContent(self, tid, pg, filter, extend):
        try:
            ...
            videos = self.getlist(data('article'), tid)
    ...
    def detailContent(self, ids):
        try:
            ...
            if not vod_content:
                vod_content = data('h2').text() or '911爆料'

            return {'list': [{'vod_play_from': '911爆料', 'vod_play_url': play_url, 'vod_content': vod_content}]}
        except:
            return {'list': [{'vod_play_from': '911爆料', 'vod_play_url': '获取失败'}]}
