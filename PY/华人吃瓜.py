...
class Spider(BaseSpider):
    ...
    def get_working_host(self):
        dynamic_urls = [
            'https://barrier.keljvwxx.cc',
            'https://asian.keljvwxx.cc',
            'https://accuse.keljvwxx.cc',
            'https://dosv1q25zn4xq.cloudfront.net'
            #发布页'https://baogua12.com'
        ]
    ...
    def homeContent(self, filter):
            ...
            classes = [
                 {'type_name': '最新吃瓜','type_id': '/category/zxcgbl/'},
                 {'type_name': '热搜排行','type_id': '/category/rmcgbl/'},
                 {'type_name': '亚洲精选','type_id': '/category/pronhub/'},
                 {'type_name': '桃色校园','type_id': '/category/zsxybl/'},
                 {'type_name': '偷拍专区','type_id': '/category/tpzq/'},
                 {'type_name': '明星网红','type_id': '/category/whscbl/'},
                 {'type_name': '反差网黄','type_id': '/category/fcnsbl/'},
                 {'type_name': '伦理道德','type_id': '/category/crycll/'},
                 {'type_name': 'AI专区','type_id': '/category/mxbzbg/'},
                 {'type_name': '欧美精选','type_id': '/category/rmbl/'}
          ]
