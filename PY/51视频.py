...
class Spider(BaseSpider):
    ...
    def get_working_host(self):
        dynamic_urls = [
            'https://beat.bmjpkpdz.cc',
            'https://behind.bmjpkpdz.cc',
            'https://analyze.bmjpkpdz.cc',
            'https://d3ms4wz4etinr5.cloudfront.net'
           #51视频发布页 'https://wlftmiiu.com'
        ]
    ...
    def homeContent(self, filter):
            ...
            classes = [
                 {'type_name': '今日推荐','type_id': '/category/wpcz/'},
                 {'type_name': '撸片精品','type_id': '/category/lpjp/'},
                 {'type_name': '每日大赛','type_id': '/category/meiridasai/'},
                 {'type_name': 'AI短剧','type_id': '/category/aisj/'},
                 {'type_name': '吃瓜爆料','type_id': '/category/rdsj/'},
                 {'type_name': '伦理精选','type_id': '/category/lljx/'},
                 {'type_name': '学生校园','type_id': '/category/xsxy/'},
                 {'type_name': '体育男大','type_id': '/category/tynd/'},
                 {'type_name': '色漫天堂','type_id': '/category/smtt/'},
                 {'type_name': '网红黑料','type_id': '/category/whhl/'},
                 {'type_name': '看片娱乐','type_id': '/category/ysyl/'},
                 {'type_name': '超前点播','type_id': '/category/cqdb/'},
                 {'type_name': '奇趣百科','type_id': '/category/qubk/'},
                 {'type_name': '51原创','type_id': '/category/51yc/'},
                 {'type_name': '短剧影视','type_id': '/category/dyds/'},
                 {'type_name': '网黄合集','type_id': '/category/whhj/'},
                 {'type_name': 'PMV混剪','type_id': '/category/pmv/'},
                 {'type_name': 'AI短剧','type_id': '/category/aisj/'},
                 {'type_name': '明星黑料','type_id': '/category/mxhl/'},
                 {'type_name': '世界杯赛','type_id': '/category/sjbs/'}
          ]
    ...
    def detailContent(self, ids):
        try:
            ...
            if not vod_content:
                vod_content = data('h2').text() or '51视频'
