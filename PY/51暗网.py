...
class Spider(BaseSpider):
    ...
    def get_working_host(self):
        dynamic_urls = [
            'https://burn.kkaglkoy.cc',
            'https://arrive.kkaglkoy.cc',
            'https://acid.kkaglkoy.cc',
            'https://d585e7i3cf7e8.cloudfront.net'
           #51暗网发布页 'https://51awb48.com'
        ]
    ...
    def homeContent(self, filter):
            ...
            classes = [
                 {'type_name': '今日吃瓜','type_id': '/category/jrrg/'},
                 {'type_name': '全网热搜','type_id': '/category/qwrs/'},
                 {'type_name': '暗网爆料','type_id': '/category/awcg/'},
                 {'type_name': '暗网网红','type_id': '/category/dywh/'},
                 {'type_name': '每日大赛','type_id': '/category/mrds/'},
                 {'type_name': 'AI短剧','type_id': '/category/aidj/'},
                 {'type_name': '暗网反差','type_id': '/category/fcll/'},
                 {'type_name': '暗网校园','type_id': '/category/xycg/'},
                 {'type_name': '暗网乱伦','type_id': '/category/anwangluanlun/'},
                 {'type_name': '暗网视频','type_id': '/category/sxzq/'},
                 {'type_name': '海外大片','type_id': '/category/hwaw/'},
                 {'type_name': '暗网AV解说','type_id': '/category/awdz/'},
                 {'type_name': '暗网猎奇','type_id': '/category/awlq/'},
                 {'type_name': '探花偷拍','type_id': '/category/tanhua/'},
                 {'type_name': '每日top','type_id': '/category/meiri-top/'},
                 {'type_name': '寸止挑战','type_id': '/category/cunzhi/'},
                 {'type_name': '动漫天堂','type_id': '/category/dmtt/'},
                 {'type_name': '暗史档案','type_id': '/category/dark-history/'},
                 {'type_name': '更多','type_id': '#'},
                 {'type_name': '世界杯','type_id': '/category/sjb/'}
          ]
    ...
    def detailContent(self, ids):
        try:
            ...
            if not vod_content:
                vod_content = data('h2').text() or '51暗网'

            return {'list': [{'vod_play_from': '51暗网', 'vod_play_url': play_url, 'vod_content': vod_content}]}
        except:
            return {'list': [{'vod_play_from': '51暗网', 'vod_play_url': '获取失败'}]}
