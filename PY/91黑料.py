...
class Spider(BaseSpider):
    ...
    def get_working_host(self):
        dynamic_urls = [
            'https://active.x91hl.com',
            'https://burn.x91hl.com',
            'https://alive.x91hl.com'
           #91黑料发布页 'https://91hl6.com'
        ]
    ...
    def homeContent(self, filter):
            ...
            classes = [
                 {'type_name': '今日热料','type_id': '/category/wpcz/'},
                 {'type_name': 'top热榜','type_id': '/category/toprb/'},
                 {'type_name': '明星黑料','type_id': '/category/whmx/'},
                 {'type_name': '网红黑料','type_id': '/category/mrdg/'},
                 {'type_name': '校园风情','type_id': '/category/xyfq/'},
                 {'type_name': '免费擦边短剧','type_id': '/category/duanju/'},
                 {'type_name': '91原创','type_id': '/category/91yc/'},
                 {'type_name': '约炮分享','type_id': '/category/ypfx/'},
                 {'type_name': '吃瓜新闻','type_id': '/category/ckxw/'},
                 {'type_name': '深夜撸片','type_id': '/category/sylp/'},
                 {'type_name': '禁忌动漫','type_id': '/category/jjdm/'},
                 {'type_name': '经典三级','type_id': '/category/jdsj/'}
          ]
    ...
    def detailContent(self, ids):
        try:
            ...
            if not vod_content:
                vod_content = data('h2').text() or '91黑料'

            return {'list': [{'vod_play_from': '91黑料', 'vod_play_url': play_url, 'vod_content': vod_content}]}
        except:
            return {'list': [{'vod_play_from': '91黑料', 'vod_play_url': '获取失败'}]}
